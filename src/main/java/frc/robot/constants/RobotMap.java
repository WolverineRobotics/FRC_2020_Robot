...
public class RobotMap{
    ...
    public static final int DRIVE_LEFT_MOTOR_SLAVE1_ADDRESS          = 2;
    public static final int DRIVE_LEFT_MOTOR_SLAVE2_ADDRESS          = 2;
    public static final int DRIVE_RIGHT_MOTOR_MASTER_ADDRESS        = 3;
    public static final int DRIVE_RIGHT_MOTOR_SLAVE1_ADDRESS         = 4;
    public static final int DRIVE_RIGHT_MOTOR_SLAVE2_ADDRESS         = 4;
