...
public class RobotMap{
    ...
    public static final int DRIVE_LEFT_MOTOR_SLAVE_ADDRESS_1         = 2;
    public static final int DRIVE_LEFT_MOTOR_SLAVE_ADDRESS_2         = 2;
    public static final int DRIVE_RIGHT_MOTOR_MASTER_ADDRESS        = 3;
    public static final int DRIVE_RIGHT_MOTOR_SLAVE_ADDRESS_1        = 4;
    public static final int DRIVE_RIGHT_MOTOR_SLAVE_ADDRESS_2        = 4;
